...
#
# Source0 file verified with key 0xB8B5FA0EFC1EC2FE (leo.liu@amd.com)
#
Name     : libdrm
Version  : 2.4.105
Release  : 73
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.105.tar.xz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.105.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.105.tar.xz.sig
...
%prep
%setup -q -n libdrm-2.4.105
cd %{_builddir}/libdrm-2.4.105
%patch1 -p1
pushd ..
cp -a libdrm-2.4.105 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619144681
