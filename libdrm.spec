...
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.117.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.117.tar.xz.sig
...
%prep
%setup -q -n libdrm-2.4.117
cd %{_builddir}/libdrm-2.4.117
pushd ..
cp -a libdrm-2.4.117 build32
popd
pushd ..
cp -a libdrm-2.4.117 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697823558
