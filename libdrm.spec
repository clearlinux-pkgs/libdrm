...
#
# Source0 file verified with key 0x95A677A230AC4AA9 (bas@basnieuwenhuizen.nl)
#
Name     : libdrm
Version  : 2.4.107
Release  : 76
...
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.107.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634131125
...
ninja -v -C builddir
CFLAGS="$CFLAGS -m64 -march=x86-64-v3 -O3" CXXFLAGS="$CXXFLAGS -m64 -march=x86-64-v3 " LDFLAGS="$LDFLAGS -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dudev=true  builddiravx2
