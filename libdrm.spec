...
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.123.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.123.tar.xz.sig
...
%setup -q -n libdrm-2.4.123
cd %{_builddir}/libdrm-2.4.123
pushd ..
cp -a libdrm-2.4.123 build32
popd
pushd ..
cp -a libdrm-2.4.123 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724787841
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdrm.so.2.123.0
/V3/usr/lib64/libdrm_amdgpu.so.1.123.0
/V3/usr/lib64/libdrm_intel.so.1.123.0
/V3/usr/lib64/libdrm_nouveau.so.2.123.0
/V3/usr/lib64/libdrm_radeon.so.1.123.0
...
/usr/lib32/libdrm.so.2.123.0
/usr/lib32/libdrm_amdgpu.so.1
/usr/lib32/libdrm_amdgpu.so.1.123.0
/usr/lib32/libdrm_intel.so.1
/usr/lib32/libdrm_intel.so.1.123.0
/usr/lib32/libdrm_nouveau.so.2
/usr/lib32/libdrm_nouveau.so.2.123.0
/usr/lib32/libdrm_radeon.so.1
/usr/lib32/libdrm_radeon.so.1.123.0
