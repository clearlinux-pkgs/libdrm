...
#
# Source0 file verified with key 0x83FD600E340FB5FF (samuel.pitoiset@gmail.com)
#
Name     : libdrm
Version  : 2.4.110
Release  : 82
URL      : https://dri.freedesktop.org/libdrm/libdrm-2.4.110.tar.xz
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.110.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.110.tar.xz.sig
...
%prep
%setup -q -n libdrm-2.4.110
cd %{_builddir}/libdrm-2.4.110
pushd ..
cp -a libdrm-2.4.110 build32
popd
pushd ..
cp -a libdrm-2.4.110 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649971349
