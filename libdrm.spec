...
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.124.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.124.tar.xz.sig
...
%setup -q -n libdrm-2.4.124
cd %{_builddir}/libdrm-2.4.124
pushd ..
cp -a libdrm-2.4.124 build32
popd
pushd ..
cp -a libdrm-2.4.124 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733396614
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdrm.so.2.124.0
/V3/usr/lib64/libdrm_amdgpu.so.1.124.0
/V3/usr/lib64/libdrm_intel.so.1.124.0
/V3/usr/lib64/libdrm_nouveau.so.2.124.0
/V3/usr/lib64/libdrm_radeon.so.1.124.0
/usr/lib64/libdrm.so.2
/usr/lib64/libdrm.so.2.124.0
/usr/lib64/libdrm_amdgpu.so.1
/usr/lib64/libdrm_amdgpu.so.1.124.0
/usr/lib64/libdrm_intel.so.1
/usr/lib64/libdrm_intel.so.1.124.0
/usr/lib64/libdrm_nouveau.so.2
/usr/lib64/libdrm_nouveau.so.2.124.0
/usr/lib64/libdrm_radeon.so.1
/usr/lib64/libdrm_radeon.so.1.124.0
