...
Source0  : https://dri.freedesktop.org/libdrm/libdrm-2.4.106.tar.xz
Source1  : https://dri.freedesktop.org/libdrm/libdrm-2.4.106.tar.xz.sig
...
%prep
%setup -q -n libdrm-2.4.106
cd %{_builddir}/libdrm-2.4.106
%patch1 -p1
pushd ..
cp -a libdrm-2.4.106 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621348726
